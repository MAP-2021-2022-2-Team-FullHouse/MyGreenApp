...
void setupLocator() {
  ...
  locator.registerLazySingleton<RewardService>(() => RewardFirebaseService());
  locator.registerLazySingleton<AppointmentService>(
      () => AppointmentServiceFirebase());
  locator.registerLazySingleton<ShopService>(() => ShopServiceFirebase());
  ...
  locator.registerLazySingleton<CreateReward_ViewModel>(
  ...
  locator.registerLazySingleton<ShopViewmodel>(() => ShopViewmodel());
