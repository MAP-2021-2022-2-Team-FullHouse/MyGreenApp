...
import 'package:mygreenapp/ui/screen/map/MapViewModel.dart';
import 'package:firebase_core/firebase_core.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:mygreenapp/ui/screen/home/home_navBar.dart';
import 'package:mygreenapp/model/RecycleCenter.dart';
                        ...
                        if(index==0){
                          return Padding(
                            ...
                            child: Column(children: [
                              ...
                              Text("Choose a recycle center or swipe up for more"),
                            ]),
                          );
                        }
                        return Card(
                          ...
                          child:Column(
                            ...
                            subtitle: Text('${centerList[index]['address'] }'),
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () {
                                MapViewModel.openMap(centerList[index]['lat'].toDouble(),centerList[index]['lon'].toDouble());
                            },
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () {
                              UrlLauncher.launch('tel:+${centerList[index]['phone']}');
                            },
                            child: Text('Call'),
                          ),
                                // FlatButton(
      ...
      setState(() {
        ...
        for (int i = 0; i < centerList.length; i++) {
          markers.add(new Marker(
            ...
            position: LatLng(centerList[i]['lat'].toDouble(), centerList[i]['lon'].toDouble()),
          ));
        }
      });
    }
